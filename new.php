...
if (isset($_POST['submit'])) {
	...
	$name = mysqli_real_escape_string($connection, htmlspecialchars($_POST['firstname']));
	...
	$q2 = mysqli_real_escape_string($connection, htmlspecialchars($_POST['q1']));
	$q3 = mysqli_real_escape_string($connection, htmlspecialchars($_POST['q1']));
	$q4 = mysqli_real_escape_string($connection, htmlspecialchars($_POST['q1']));
	$q5 = mysqli_real_escape_string($connection, htmlspecialchars($_POST['q1']));
